...
leetcode: (props: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.483 0a1.25 1.25 0 0 0-.883.366L3.05 9.917a3.75 3.75 0 0 0 0 5.303l3.73 3.73a3.75 3.75 0 0 0 5.303 0l2.084-2.084a1.25 1.25 0 1 0-1.768-1.768l-2.084 2.084a1.25 1.25 0 0 1-1.768 0l-3.73-3.73a1.25 1.25 0 0 1 0-1.768l9.55-9.55A1.25 1.25 0 0 0 13.483 0z"/>
    <path d="M8.75 12a1.25 1.25 0 0 1 1.25-1.25h9a1.25 1.25 0 1 1 0 2.5h-9A1.25 1.25 0 0 1 8.75 12z"/>
  </svg>
),
